...
| `diskv2` | `style_diskv2.py` | 横屏 320×240 | 紧凑字体 | 高密度显示最多十五块磁盘 |
| `diskv3` | `style_diskv3.py` | 横屏 320×240 | 紧凑字体 | 顶部显示 IP 的十五磁盘视图 |
| `diskv4` | `style_diskv4.py` | 横屏 320×240 | 紧凑字体 | 实心趋势与空磁盘占位视图 |
| `horizontal_disk` | `style_horizontal_disk.py` | 横屏 320×240 | 二寸屏字体 | 高密度显示最多九块磁盘 |
| `horizontal_diskv2` | `style_horizontal_diskv2.py` | 横屏 320×240 | 紧凑字体 | 原九磁盘布局的紧凑字体版本 |
