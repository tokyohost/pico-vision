...
class WebSocketClientCommandMixin:
    ...
    def request_websocket_client_list(self, result_queue=None):
        """安排主循环查询设备保存的客户端清单。"""
        self.websocket_client_operations.put(("list", None, result_queue))

    def request_websocket_client_update(self, payload, result_queue=None):
        """校验并安排客户端启用状态或优先级更新。"""
        ...
        self.websocket_client_operations.put(("update", operation, result_queue))
    ...
    def publish_websocket_client_operation(self):
        ...
        operation = self.websocket_client_operations.get_nowait()
