...
CONFIG_ENV_MAP = {
    ...
    "PICO_MONITOR_FORCE_USB_CDC": ("network", "force_usb_cdc"),
    "PICO_MONITOR_WEBSOCKET_CLIENT_NAME": ("network", "websocket_client_name"),
    "PICO_MONITOR_WEBSOCKET_CLIENT_ID": ("network", "websocket_client_id"),
    "PICO_MONITOR_WIFI_DISCOVERY_STRATEGY": ("network", "discovery_strategy"),
    "PICO_MONITOR_WIFI_ANNOUNCEMENT_PORT": ("network", "announcement_port"),
    "PICO_MONITOR_WIFI_ANNOUNCEMENT_GROUP": ("network", "announcement_group"),
    ...
    "PICO_MONITOR_MARKET_URL": ("market", "url"),
