...
analysis = Analysis(
    ...
    binaries=[],
    datas=[],
    hiddenimports=["psutil", "serial", "serial.tools.list_ports", "pystray._win32", "PIL.Image", "PIL.ImageDraw", "pico_upgrade", "build_info", "windows_settings", "tkinter", "tkinter.ttk", "tkinter.messagebox"],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
