...
class _Device:
    ...
    """管理运行时 USB 描述符、接口、端点与传输回调。"""
    def __init__(self):
        """初始化底层 USBDevice 对象及接口和端点映射。"""
