...
// 正面开窗和原卡钩/螺柱基准保持不动，避免把黑边差一起平移，也避免卡钩过度靠近短边内壁。
...
screen_fixing_y = screen_mount_base_y;         // -1.92，卡钩、螺柱和压板保持原位
...
screen_hook_inner_y = screen_fixing_y - screen_recess_h/2;
...
screen_clamp_pad_y = screen_fixing_y + 25.50;
screen_cover_hook_pad_x = 14.50;
screen_cover_hook_pad_y = screen_fixing_y - 25.50;
